internal static partial class Program
{
    ...
    [
        ...
        ("CLI validate blocks structural package and field policy violations", CliValidateBlocksStructuralPackageAndFieldPolicyViolations),
        ("CLI validate blocks absolute root media and unresolved image references", CliValidateBlocksAbsoluteRootMediaAndUnresolvedImageReferences),
        ...
        ("CLI rules merge applies project policy overrides", CliRulesMergeAppliesProjectPolicyOverrides),
        ...
        ("CLI assemble can insert front matter documents before thesis body", CliAssembleCanInsertFrontMatterDocumentsBeforeThesisBody),
        ("CLI assemble can insert content images", CliAssembleCanInsertContentImages),
        ("CLI assemble keeps distinct images when media basenames collide", CliAssembleKeepsDistinctImagesWhenMediaBasenamesCollide),
        ("CLI assemble normalizes shared and parent-relative image targets", CliAssembleNormalizesSharedAndParentRelativeImageTargets),
        ...
        ("Template profile builder extracts structural package and zone policies", TemplateProfileBuilderExtractsStructuralPackageAndZonePolicies),
