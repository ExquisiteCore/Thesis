...
public static partial class OpenXmlMicroEditor
{
        ...
        bool writeChanges)
    {
        return operation.Op switch
        {
            ...
            "replaceText" => ReplaceText(context, options, operation, writeChanges),
            "replaceRegex" => ReplaceRegex(context, options, operation, writeChanges),
            ...
            "insertTable" => InsertTable(context, options, operation, writeChanges),
            "deleteTable" => DeleteTable(context, options, operation, writeChanges),
            "mergeCells" => MergeCells(context, options, operation, writeChanges),
            "splitCell" => SplitCell(context, options, operation, writeChanges),
            ...
            "insertTocField" => InsertTocField(context, options, operation, writeChanges),
            "markTocNeedsUpdate" => MarkTocNeedsUpdate(context, operation, writeChanges),
            "updateSimpleFields" => UpdateSimpleFields(context, operation, writeChanges),
            "normalizeRuns" => NormalizeRuns(context, options, operation, writeChanges),
            "removeExtraSpaces" => RemoveExtraSpaces(context, options, operation, writeChanges),
            "normalizeChinesePunctuationSpacing" => NormalizeChinesePunctuationSpacing(context, options, operation, writeChanges),
            "removeDuplicatePageBreaks" => RemoveDuplicatePageBreaks(context, operation, writeChanges),
            "ensureRoleOrder" => EnsureRoleOrder(context, operation, writeChanges),
            ...
            "replaceReferences" => ReplaceReferences(context, options, operation, writeChanges),
            "insertReferenceItem" => InsertReferenceItem(context, options, operation, writeChanges),
            "applyReferenceFormat" => ApplyReferenceFormat(context, options, operation, writeChanges),
